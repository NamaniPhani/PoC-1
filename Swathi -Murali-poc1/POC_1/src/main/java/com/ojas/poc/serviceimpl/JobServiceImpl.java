...
import static com.ojas.poc.constants.Constants.EXCEL_READ_DATA;
import static com.ojas.poc.constants.Constants.EXCEL_UPLOAD_ONLY;
...
public class JobServiceImpl implements JobService {
	...
	public ResponseEntity<Object> saveAll(MultipartFile file) {
		try {
			...
			List<Job> jobs = ExcelDataRead.excelToJob(file.getInputStream());
