...
public class JobControllerTest {
	...
	public void getByJobIdTest() throws Exception {
		when(jobService.getByJobId(1)).thenReturn(entity);
		ResponseEntity<Object> byJobId = jobContoller.getByJobId(1);
	...
	@Test
	public void readExcelDataTest() throws Exception {
		when(jobService.saveAll(file)).thenReturn(entity);
		ResponseEntity<Object> excelData = jobContoller.uploadFile(file);
		assertEquals(excelData.getStatusCode(), HttpStatus.OK);
	}
